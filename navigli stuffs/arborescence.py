...
def getArborescence(E, r, w):
    ...
    trimmed_Ew = sorted(trimmed_Ew, key=lambda x: x, reverse=False)
    return getPairs(trimmed_Ew)
...
edges = [(0,1),(0,2),(0,5),(1,3),(1,4),(2,5),(3,0),(4,2),(4,6),(5,4),(5,7)]
root = 0
weights = [1,1,11,1,1,1,12,13,1,14,1]

edges = getArborescence(edges, root, weights)
print(edges)
